  ...
  return (
    <div className="w-screen blueBG h-auto px-5 ">
      <div className="container flex flex-col md:flex-row justify-center items-center gap-8 ">
        <div className="left  ">
          <Image priority className="  h-[400px] md:min-h-[600px] w-auto" src="/tahsan.webp" alt="Man dressed indochino" height={800} width={534} />
        </div>
        <div className="right text-white  max-w-[400px] text-center md:text-left mb-10 md:mb-0">
          <h2 className="text-4xl  font-bold uppercase">The Tailor is in</h2>
          <p className="mt-5">The ultimate custom menswear experience is now open in Chinock Centre.</p>
          <hr className="w-full h-[1px] bg-white my-10" />
